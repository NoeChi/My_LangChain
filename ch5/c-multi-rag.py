...
def router_node(state: State) -> State:
    ...
    print("messages to router_node:", messages)
    print("---------------------------")
    # 區分類別
    res = model_low_temp.invoke(messages) # invoke 就有一個 chunk
    print('use router_node:', res)
    print("---------------------------")
    return {
        "domain": res.content,
...
def retrieve_medical_records(state: State) -> State:
    print("retrieve_medical_records state:", state)
    print("---------------------------")
...
def retrieve_insurance_faqs(state: State) -> State:
    print("retrieve_insurance_faqs state:", state)
    print("---------------------------")
    # retieve 放在 documents 
...
def generate_answer(state: State) -> State:
    print("generate_answer state:", state)
    print("---------------------------")
    if state["domain"] == "records":
